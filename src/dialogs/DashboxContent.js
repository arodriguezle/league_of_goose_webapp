...
import { getKeyByValue, getDashboardDescription } from "../domain/logics";
...
const DashboxContent = props => {
	...
	return (
		...
		>
			...
			>
				<div className="relative top-[3%] left-[15%] w-[70%] h-[20%] flex justify-center items-center text-[black] text-normal font-bold uppercase">
				...
				<div className="absolute bottom-[7%] left-[15%] w-[70%] h-[20%] flex justify-center items-center text-[black] text-sm font-bold uppercase">
					{getDashboardDescription(DASHBOX_TYPES_ACTIONS[getKeyByValue(DASHBOX_TYPES, props.info.value)])}
				</div>
			</div>
		</Dialog>
	);
